...
<!-- Mirrored from hencework.com/theme/bunny/full-width-light/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jan 2018 03:13:29 GMT -->
<head>
		<meta charset="UTF-8" />
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Class Registration Form</h3>
											<h6 class="text-center nonecase-font txt-grey">Enter your class details below</h6>
										</div>	
										<div class="form-wrap">
											<form action="#">
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputName_1">Name of the class</label>
													<input type="email" class="form-control" required="" id="exampleInputName_1" placeholder="Class name">
												</div>
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputEmail_2">Class Teacher</label>
												...
												<div class="form-group text-center">
													<button type="submit" class="btn btn-warning btn-rounded">register class</button>
												</div>
											</form>
										</div>
									</div>	
