...
<!-- Mirrored from hencework.co m/theme/bunny/full-width-light/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jan 2018 03:13:29 GMT -->
<head>
		<meta charset="UTF-8" />
										...
										<div class="form-wrap">
											<form action="#">
												<div class="form-group">
													...
													<input type="text" class="form-control" required="" id="exampleInputName_2" placeholder="ID">
